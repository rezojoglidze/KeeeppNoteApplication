...
import com.keppnoteapp.Repository.WordRepository
import com.keppnoteapp.RoomDatabase.Entity.Word
import com.keppnoteapp.RoomDatabase.WordRoomDatabase
...
class WordViewModel(application: Application) : AndroidViewModel(application) {
    ...
    init {
        ...
        val wordsDao = WordRoomDatabase.getDatabase(
            ...
            .wordDao()   //updatemde val wordsDao = WordRoomDatabase.getDatabase(application).wordDao()
